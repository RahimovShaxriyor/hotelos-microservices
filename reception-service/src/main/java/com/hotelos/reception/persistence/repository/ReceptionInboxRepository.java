...
@Repository
public interface ReceptionInboxRepository extends JpaRepository<ReceptionInboxEventEntity, UUID> {

    @Modifying
    @Query(value = """
            INSERT INTO reception.inbox_events (event_id, event_type, source, aggregate_id, correlation_id, envelope_hash, received_at, processed_at)
