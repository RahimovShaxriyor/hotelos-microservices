...
@Entity
@Table(name = "outbox_events", schema = "room_service")
public class RoomServiceOutboxEventEntity {
    ...
    protected RoomServiceOutboxEventEntity() {}

    public RoomServiceOutboxEventEntity(
            UUID eventId,
            String eventType,
            int eventVersion,
            String source,
